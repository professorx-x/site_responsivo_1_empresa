...
$(document).ready(function()
{
	...
	if(window.innerWidth > altu)
	{
		...
		document.getElementById('box_muda_slide').style.display = 'block';	
	}
	else
	{
		...
		document.getElementById('box_muda_slide').style.display = 'none';	
...
function home()
{
	var alt = $('#ima_back').offset().top;
	$('body, html').animate({"scrollTop": alt}, 800);
...
function videos()
{
	var alt = Math.round($("#videos").offset().top - 90);
	$("body, html").css({"scrollTop": alt}, 800);	
	//alert(altu);
}

function contatos()
{
	var alt = $("#contato").offset().top - 90;
	$('body, html').animate({scrollTop: alt}, 800);
